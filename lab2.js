  ...
  myName.addEventListener('click', function() {
      myName.classList.remove('req');
  })

  var myMale = document.getElementById('email');
  myMale.addEventListener('click', function() {
      myMale.classList.remove('req');
  })

  var someWords = document.getElementById('someWords');
  someWords.addEventListener('click', function() {
      someWords.classList.remove('req');
  })
